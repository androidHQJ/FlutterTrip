...
class FirstRouteWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('FirstFlutter Route'),
      ),
      body: Center(
        child: RaisedButton(
          child: Text('Open secondflutter route'),
          onPressed: () {
            FlutterBoost.singleton.openPage("secondflutter", {}, animated: true);
          },
        ),
      ),
    );
...
class SecondRouteWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("SecondFlutter Route"),
      ),
      body: Center(
        child: RaisedButton(
          onPressed: () {
