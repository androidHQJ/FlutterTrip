...
import 'package:android_with_flutter/db/db.dart';
import 'package:android_with_flutter/generated/i18n.dart';
import 'package:android_with_flutter/model/hotword.dart';
import 'package:android_with_flutter/net/dio_manager.dart';
import 'package:android_with_flutter/ui/home/search_result_page.dart';
...
import 'package:android_with_flutter/widget/icon_text_widget.dart';
                ...
                onPressed: () {
                  ...
                  if (key.isEmpty) {
                    Fluttertoast.showToast(
                        msg: S.of(context).keyword_cannot_be_empty);
                    return;
                  }
